...
import SyncLlmoButton from './sync-llmo-button'
    ...
    <div>
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <SyncLlmoButton />
          <Link
            href="/dashboard/llmo/prompts/from-templates"
          ...
          <Link
            href="/dashboard/llmo/prompts/new"
        ...
        <EmptyState
          ...
          action={total === 0 ? (
            <div className="flex gap-2">
              <Link href="/dashboard/llmo/prompts/from-templates" className={buttonVariants({ variant: 'outline', size: 'sm' })}>
                テンプレートから追加
              </Link>
              <Link href="/dashboard/llmo/prompts/new" className={buttonVariants({ size: 'sm' })}>
                + 追加
              </Link>
            </div>
          ) : undefined}
          ...
          <TableBody>
            {prompts.map((p) => (
              <TableRow key={p.id}>
                <TableCell>
                  <Link
                    href={`/dashboard/llmo/prompts/${p.id}`}
